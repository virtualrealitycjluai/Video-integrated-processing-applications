...
def main(video_path, output_video_path):
    ...
    parser.add_argument('--model_pool', type=str, default='model/dncnn25/models', help='path of model_zoo')
    parser.add_argument('--results', type=str, help='Path to the output results')
